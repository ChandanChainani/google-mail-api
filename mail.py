...
def mail_otp(receiver, pin_code, username):
    ...
    message = send_inst.create_otp('your-email-id@gmail.com', receiver, 'Message you want to set',
                                   pin_code, username)
...
def mail_info(receiver, user):
    send_inst = sendemail.SendEmail(service)
    message = send_inst.create_message('your-email-id@gmail.com', receiver,
...
def mail_me(name, sender, mobile, message):
    send_inst = sendemail.SendEmail(service)
    message = send_inst.create_message_for_me('your-email-id@gmail.com', 'your-email-id@gmail.com',
...
# info = f"""name: {name}\nEmail: {sender}\nMobile: {mobile}\nMessage: {message}"""
# send_inst = sendemail.SendEmail(service)
# message = send_inst.create_message_with_attachment('your-email-id@gmail.com', 'your-email-d@gmail.com',
